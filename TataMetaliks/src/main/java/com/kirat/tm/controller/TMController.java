...
//	public String gatepassURL = "http://14.141.110.54:8080/GatePassManagement";
	...
	public @ResponseBody JsonResponse userAuthenticate(@RequestBody ModelMap requestModel)
	...
	public @ResponseBody JsonResponse loginUser(@RequestBody ModelMap requestModel)
			throws MPXJException, JsonParseException, JsonMappingException, IOException {
		// exceptionLog.setRequestObject(requestModel);
	...
	public @ResponseBody JsonResponse Relogin(@RequestBody ModelMap requestModel)
			throws MPXJException, JsonParseException, JsonMappingException, IOException {
	...
	public @ResponseBody JsonResponse showCreateCasePage(@RequestBody Project project) throws JsonParseException,
...
//		XSSFSheet sheet = (XSSFSheet) workbook.createSheet("Sheet 1");
	...
	@RequestMapping(value = "/mppcontent", method = RequestMethod.POST)
	public @ResponseBody JsonResponse mppcontent(@RequestBody ModelMap modelmap) throws IOException, MPXJException {
	...
	public @ResponseBody List<Resources> resourceList(@RequestBody ModelMap requestModel) throws MPXJException {
		ProjectReader reader = new MPPReader();
	...
	public @ResponseBody List<Tasks> taskList(@RequestBody ModelMap requestModel) throws MPXJException {
	...
	@RequestMapping(value = "/mpp.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse mpplist() throws IOException {
	...
	@RequestMapping(value = "/parentTask.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse parentTask(@RequestBody ModelMap model) throws IOException {
	...
	@RequestMapping(value = "/childTask.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse childTask(@RequestBody ModelMap model) throws IOException {
		// exceptionLog.setRequestObject(model);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/gridData.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse gridData() throws IOException {
	...
	@RequestMapping(value = "/fetchProjectDetails.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse fetchProjectDetails(@RequestBody ModelMap model) throws IOException {
		// exceptionLog.setRequestObject(model);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/fetchAllDetails.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse fetchAllDetails(@RequestBody ModelMap model) throws IOException, ParseException {
		try {
			// exceptionLog.setRequestObject(model);
			JsonResponse jsonResponse = new JsonResponse();
			ObjectMapper mapper = new ObjectMapper();
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/fetchMasterCategory.web", method = RequestMethod.GET)
	public @ResponseBody JsonResponse fetchMasterCategory() throws IOException {
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/fetchMasterSubCategory.web", method = RequestMethod.GET)
	public @ResponseBody JsonResponse fetchMasterSubCategory() throws IOException {
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/fetchProjectList.web", method = RequestMethod.GET)
	public @ResponseBody JsonResponse fetchProjectList() throws IOException {
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/getProjectSheetByProjectId/{id}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getProjectSheetByIdProjectId(@PathVariable("id") String id)
	...
	@RequestMapping(value = "/createSheets.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse createSheets(@RequestBody ModelMap model) throws IOException {
		// exceptionLog.setRequestObject(model);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/updateSheets.web", method = RequestMethod.POST)
...
//			}
	...
	@RequestMapping(value = "/createProjectSummary.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse createProjectSummary(@RequestBody ProjectSummary summary) throws IOException {
	...
	@RequestMapping(value = "/helpAnswer/{getid}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse helpAnswer(@PathVariable("getid") String getid)
			throws JsonParseException, JsonMappingException, IOException {
	...
	@RequestMapping(value = "/createProjectStatus.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse overallCompletion(@RequestBody Project project) throws IOException {
		// exceptionLog.setRequestObject(project);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/getProjectDetails.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse getProjectDetails(@RequestBody ModelMap model) throws IOException {
		// exceptionLog.setRequestObject(model);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/updateProjectDetails.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse updateprojectdetails(@RequestBody Project project) throws IOException {
		// exceptionLog.setRequestObject(project);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
...
//				+ project.getProjectid() + " " + project.getProjectname() + ".xlsx");
	...
	@RequestMapping(value = "/getSummaryDetails.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse getSummaryDetails(@RequestBody ModelMap model) throws IOException {
		// exceptionLog.setRequestObject(model);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/updateProjectSummary.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse updateProjectSummary(@RequestBody ProjectSummary summary) throws IOException {
		// exceptionLog.setRequestObject(summary);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/createPlaylist.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse createPlaylist(@RequestBody ModelMap modelMap) throws IOException {
	...
	@RequestMapping(value = "/getPlaylistDetails.web", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getPlaylistDetails() throws IOException {
		JsonResponse jsonResponse = new JsonResponse();
	...
	@RequestMapping(value = "/docDetailsByProjectId.web/{id}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse docDetailsByProjectId(@PathVariable("id") String projectid)
			throws JsonParseException, JsonMappingException, IOException {
		ModelMap errmodel = new ModelMap();
		errmodel.addAttribute("projectid", projectid);
		// exceptionLog.setRequestObject(errmodel);
	...
	@RequestMapping(value = "/playlistCountIncrement.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse playlistCountIncrement(@RequestBody PlaylistHeader playlistHeader)
			throws IOException {
	...
	@RequestMapping(value = "/getProjectListById.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse getProjectListById(@RequestBody ModelMap model) throws IOException {
		// exceptionLog.setRequestObject(model);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/fetchTaskManagementList.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse fetchTaskList(@RequestBody ModelMap model) throws IOException {
		// exceptionLog.setRequestObject(model);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/createAccount.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse createAccount(@RequestBody Account account) throws IOException {
	...
	@RequestMapping(value = "/updateProjectArchive", method = RequestMethod.POST)
	public @ResponseBody JsonResponse updatearchiveProject(@RequestBody ModelMap modelMap) throws IOException {
		// exceptionLog.setRequestObject(modelMap);
		ObjectMapper mapper = new ObjectMapper();
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/updateProjectImageArchive", method = RequestMethod.POST)
	public @ResponseBody JsonResponse updatearchiveProjectImage(@RequestBody ModelMap modelMap) throws IOException {
		// exceptionLog.setRequestObject(modelMap);
		ObjectMapper mapper = new ObjectMapper();
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/saveDocStyle", method = RequestMethod.POST)
	public @ResponseBody JsonResponse saveDocStyle(@RequestBody ModelMap modelMap) throws IOException {
		// exceptionLog.setRequestObject(modelMap);
		ObjectMapper mapper = new ObjectMapper();
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/updateProjectVideoArchive", method = RequestMethod.POST)
	public @ResponseBody JsonResponse updatearchiveProjectVideo(@RequestBody ModelMap modelMap) throws IOException {
	...
	@RequestMapping(value = "/getDocListById.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse getDocListById(@RequestBody ModelMap model) throws IOException {
		// exceptionLog.setRequestObject(model);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/deletePlaylistByProjId.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse deletePlaylistByProjId(@RequestBody ModelMap model) throws IOException {
		// exceptionLog.setRequestObject(model);
		JsonResponse jsonResponse = new JsonResponse();
		Status status = new Status();
		ObjectMapper mapper = new ObjectMapper();
	...
	@RequestMapping(value = "/createInterval", method = RequestMethod.POST)
	public @ResponseBody JsonResponse createInterval(@RequestBody ProjectInterval projectInterval) throws IOException {
	...
	public @ResponseBody JsonResponse updateInterval(@RequestBody ProjectInterval projectInterval) throws IOException {
		// exceptionLog.setRequestObject(projectInterval);
		ObjectMapper mapper = new ObjectMapper();
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/getIntervalByProjectId/{id}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse updateInterval(@PathVariable("id") String id) throws IOException {
	...
	@RequestMapping(value = "/getAllMppListById.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse getAllMppListById(@RequestBody ModelMap model)
	...
	@RequestMapping(value = "/getProjectDetailsById.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse getProjectDetailsById(@RequestBody ModelMap model)
			throws IOException, ParseException {
		// exceptionLog.setRequestObject(model);
		ArrayList<Hybrid> List = new ArrayList<Hybrid>();
		JsonResponse jsonResponse = new JsonResponse();
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/getColumnList.web", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getColumnList() throws IOException {
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/getPlaylistDetailsById.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse getPlaylistDetailsbyId(@RequestBody ModelMap model) throws IOException {
		JsonResponse jsonResponse = new JsonResponse();
		ModelMap responsemodel = new ModelMap();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/updatePlaylist.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse updatePlaylist(@RequestBody ModelMap modelMap) throws IOException {
		// exceptionLog.setRequestObject(modelMap);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/getContractorPrifileByIdWithContractorList/{id}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getContractorPrifileByIdWithContractorList(@PathVariable("id") String id)
			throws Exception {
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/getLabourDetailsById/{id}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getLabourDetailsById(@PathVariable("id") String id) throws Exception {
		ModelMap model = new ModelMap();
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/getDailyReports/{id}/{date}/{todt}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getDailyReports(@PathVariable("id") String id, @PathVariable("date") String date
	...
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/getContractorStatisticDataById/{id}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getContractorStatisticDepartmentData(@PathVariable("id") String id)
			throws JsonParseException, JsonMappingException, IOException {
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
		ModelMap model = new ModelMap();
	...
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/getPurchaseOrderListByContractorId/{id}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getPurchaseOrderListByContractorId(@PathVariable("id") String id)
			throws JsonParseException, JsonMappingException, IOException {
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
	...
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/getStatisticPageData", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getStatisticPageData()
	throws JsonParseException, JsonMappingException, IOException {
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
		ModelMap responsemodel = new ModelMap();
	...
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/getLabourListByDepartmentId/{id}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getLabourListByDepartmentId(@PathVariable("id") String id)
			throws JsonParseException, JsonMappingException, IOException {
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
	...
	public @ResponseBody JsonResponse getMapData()
			throws JsonParseException, JsonMappingException, IOException {
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
	...
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/getDlyRptForMapBydept/{dept}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getDlyRptForMapBydept(@PathVariable("dept") String dept)
	throws JsonParseException, JsonMappingException, IOException {
	JsonResponse jsonResponse = new JsonResponse();
	RestTemplate restTemplate = new RestTemplate();
	...
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/getDlyRptForMapBySubdept/{dept}/{subDept}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getDlyRptForMapBySubdept(@PathVariable("dept") String dept,
	...
	public @ResponseBody JsonResponse getTest()
			throws JsonParseException, JsonMappingException, IOException {
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/insrtGrphDta.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse insrtGrphDta(@RequestBody GraphData graphData) throws IOException {
		// exceptionLog.setRequestObject(summary);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/getgrphDta.web", method = RequestMethod.POST)
	public @ResponseBody JsonResponse getgrphDta(@RequestBody ModelMap model) throws IOException {
		// exceptionLog.setRequestObject(model);
		JsonResponse jsonResponse = new JsonResponse();
		ObjectMapper mapper = new ObjectMapper();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/updategrphDta", method = RequestMethod.POST)
	public @ResponseBody JsonResponse updategrphDta(@RequestBody GraphData grphDta) throws IOException { 
		// exceptionLog.setRequestObject(projectInterval);
		ObjectMapper mapper = new ObjectMapper();
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
	...
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/getSubDptByMstDpt/{id}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getDailyReports(@PathVariable("id") String id)
			{
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
...
//	@PathVariable("date") String date)
	@RequestMapping(value = "/getDailyReportsByDept", method = RequestMethod.POST)
	public @ResponseBody JsonResponse getDailyReportsByDept(@RequestBody ModelMap model)
			throws JsonParseException, JsonMappingException, IOException {
		// JsonResponse jsonResponse = new JsonResponse();
		// RestTemplate restTemplate = new RestTemplate();
...
//	@PathVariable("date") String date)
	@RequestMapping(value = "/getDailyReportsByCntDept", method = RequestMethod.POST)
	public @ResponseBody JsonResponse getDailyReportsByCntDept(@RequestBody ModelMap model)
	throws JsonParseException, JsonMappingException, IOException {
	JsonResponse jsonResponse = new JsonResponse();
	RestTemplate restTemplate = new RestTemplate();
	ObjectMapper mapper = new ObjectMapper();
	...
	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/getSaftyorCrntPrsntLbrLst/{idnt}", method = RequestMethod.GET)
	public @ResponseBody JsonResponse getSaftyorCrntPrsntLbrLst(@PathVariable("idnt") String idnt)
	throws Exception { 
	JsonResponse jsonResponse = new JsonResponse();
	RestTemplate restTemplate = new RestTemplate();
	...
	public @ResponseBody JsonResponse validateOTP(@RequestBody ModelMap requestModel)
			throws JsonParseException, JsonMappingException, IOException {
		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
	...
	@RequestMapping(value = "/regenOTP", method = RequestMethod.POST)
	public @ResponseBody JsonResponse regenOTP(@RequestBody ModelMap requestModel)
			throws JsonParseException, JsonMappingException, IOException {
//		JsonResponse jsonResponse = new JsonResponse();
		RestTemplate restTemplate = new RestTemplate();
		ServiceResponse transactionsres = restTemplate.getForObject(
...
//		jsonResponse.setResult(transactionsres);
	...
	@RequestMapping(value = "/loginCSRUser", method = RequestMethod.POST)
	public @ResponseBody JsonResponse loginCSRUser(@RequestBody ModelMap requestModel)
			throws MPXJException, JsonParseException, JsonMappingException, IOException {
		// exceptionLog.setRequestObject(requestModel);
		System.out.println("login user");
		JsonResponse jsonResponse = new JsonResponse();
